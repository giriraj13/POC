...
namespace CMS.DocumentEngine.Types.MEDIO
{
	...
	public partial class Blog : TreeNode
	{
		...
		/// </summary>
		public const string CLASS_NAME = "MEDIO.Blog";
		...
		public string BlogContent
		{
			get
			{
				return ValidationHelper.GetString(GetValue("BlogContent"), @"");
			}
			set
			{
				SetValue("BlogContent", value);
			}
		}
		...
		public partial class BlogFields : AbstractHierarchicalObject<BlogFields>
		{
			...
			public string Content
			{
				get
				{
					return mInstance.BlogContent;
				}
				set
				{
					mInstance.BlogContent = value;
				}
			}
		}
